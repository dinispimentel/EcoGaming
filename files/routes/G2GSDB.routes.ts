...
import {load_g2g_deals, req_best_deals, retrieve_cache_offerbook, scraper_app_id, scraper_app_price, scraper_blacklist_add, scraper_brand, scraper_brand_scan, scraper_price, scraper_status} from '../controllers/G2GSDB.controllers'
const PREFIX = "/g2gsdb/"
